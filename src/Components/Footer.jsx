...
export default function Footer({ bgColor, textColor, elementText, elementBg }) {
  return (
    <footer className={` ${bgColor} ${textColor} text-dark-grey mt-5`}>
            ...
            <div className="col-span-2">
              <div>
                ...
                <p className="mt-4 text-gray-700">
                  Ogni adozione è una storia da raccontare. E tu, vuoi essere il
                  protagonista della prossima? Tieniti aggiornato! Scopri quali
                  amici a quattro zampe ti aspettano per iniziare una nuova
                  avventura.
                </p>
              </div>
            </div>
            ...
            <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
              <form className="w-full">
                ...
                <div className=" p-2  sm:flex sm:items-center sm:gap-0 pb-10">
                  ...
                  <button
                    className={`${elementBg} mt-1 w-full bg-pink text-dark-grey px-6 py-3 text-sm font-bold uppercase tracking-wide hover:bg-light-grey sm:mt-0 sm:w-auto sm:shrink-0 rounded-md rounded-l-none`}
                  >
                    Iscriviti
                  </button>
                </div>
