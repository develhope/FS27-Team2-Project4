  ...
  >
    <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right ">
      ...
      <div className="mt-8 flex flex-wrap gap-4 text-center">
        <Link
          to="/Adozioni"
          className="block w-full rounded bg-pink px-12 py-3 text-sm font-medium text-white shadow hover:bg-white border-pink  border-2 hover:text-pink focus:outline-none  active:bg-light-grey sm:w-auto"
        >
          Adotta Ora
        </Link>
        ...
        <Link
          to="/about"
          className="block w-full rounded bg-white px-12 py-3 text-sm font-medium text-pink border-2 border-pink shadow hover:text-white focus:outline-none hover:bg-pink active:text-light-grey sm:w-auto"
        >
          Scopri di più
        </Link>
      </div>
